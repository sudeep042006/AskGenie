...
const Sidebar = ({ bots, onSelectBot, onNewChat, onDeleteBot, onLogout }) => {
  ...
  return (
    <aside className="w-72 h-screen p-4 flex flex-col gap-4 z-40">
      <div className="glass-card rounded-[2rem] p-5 flex flex-col h-full bg-slate-900/60 backdrop-blur-2xl border border-white/10 shadow-2xl">
        ...
        <div className="pt-4 mt-auto border-t border-white/5 space-y-1">
          <button className="w-full flex items-center gap-3 p-2.5 text-sm text-slate-400 hover:text-white hover:bg-white/5 rounded-xl transition-colors">
